...
baseUrl: https://raw.githubusercontent.com/rapyd-cloud/rapyd-vz-support/relay-51/rapyd-relay-addon/
...
actions:
  ...
  installScripts:
    - cmd[${targetNodes.nodeGroup}]: |-
        ...
        curl -O ${baseUrl}996-rapyd-relay.ini
        chmod +x /usr/local/rapyd/rapyd-relay-files/996-rapyd-relay.ini
